...
VOICE_CONNECT_TIMEOUT_SECONDS = int(os.environ.get("VOICE_CONNECT_TIMEOUT_SECONDS", "60"))
POMODORO_FOCUS_SECONDS = 25 * 60
POMODORO_BREAK_SECONDS = 5 * 60
POMODORO_LONG_BREAK_SECONDS = 30 * 60
POMODORO_LONG_BREAK_INTERVAL = 4
EXTRACT_CACHE_SECONDS = 30 * 60
...
HELP_POMODORO_LONG = "Toggles a repeating 25 minute focus and 5 minute break timer."
